...
class JsonRestHelper(object):
  ...
  def is_authorized(self):
    return auth.is_authorized(self.handler.request)
  ...
  def delete(self, prefix=None):
    ...
    if not self.is_authorized():
      self.handler.response.set_status(403, "You don't have permission to access on this server.")
      return self._serve({})
